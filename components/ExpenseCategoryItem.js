          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="relative flex-shrink-0">
                <div
                  className="w-12 h-12 rounded-xl flex items-center justify-center text-white font-bold text-lg shadow-lg leading-none"
              ...
              <div className="text-left">
                <h4 className="text-lg font-semibold text-gray-800 capitalize group-hover:text-blue-600 transition-colors duration-300">
                  {expense.title}
                </h4>
